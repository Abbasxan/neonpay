...
neonpay.create_payment_stage("premium", stage)
    ...
    def print_comparison_table(self):
        ...
        for lib_id, data in self.comparison_data.items():
            print(f"{data['name']:<15} {data['complexity']:<12} {data['features']:<8} {data['best_for']:<25}")
    ...
    def print_performance_comparison(self):
        ...
        performance_data = {
            ...
            "pyrogram": {"speed": "Very Fast", "memory": "Very Low", "scalability": "Very High"},
            "telebot": {"speed": "Medium", "memory": "Medium", "scalability": "Medium"},
            "ptb": {"speed": "Medium", "memory": "Medium", "scalability": "High"},
            "raw_api": {"speed": "Very Fast", "memory": "Very Low", "scalability": "Very High"}
        }
        ...
        for lib_id, data in self.comparison_data.items():
            ...
            print(f"{data['name']:<15} {perf['speed']:<12} {perf['memory']:<12} {perf['scalability']:<12}")
