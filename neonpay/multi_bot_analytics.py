...
class MultiBotAnalyticsManager:
    ...
    def __init__(self, enable_analytics: bool = True) -> None:
        ...
        self.engine = MultiBotAnalyticsEngine(self.collector) if self.collector is not None else None
        self.dashboard = MultiBotAnalyticsDashboard(self.engine) if self.engine is not None else None
